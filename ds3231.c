...
static ds3231_err_t ds3231_bus_initialize(ds3231_t const *ds3231) {
  assert(ds3231);

  if (ds3231->interface.bus_initialize) {
    return ds3231->interface.bus_initialize(ds3231->interface.bus_user);
  }

  return DS3231_ERR_NULL;
}

static ds3231_err_t ds3231_bus_deinitialize(ds3231_t const *ds3231) {
  assert(ds3231);

  if (ds3231->interface.bus_deinitialize) {
    return ds3231->interface.bus_deinitialize(ds3231->interface.bus_user);
  }

  return DS3231_ERR_NULL;
}

static ds3231_err_t ds3231_bus_write_data(ds3231_t const *ds3231,
                                          uint8_t write_address,
                                          uint8_t const *write_data,
                                          size_t write_size) {
  assert(ds3231);

  if (ds3231->interface.bus_write_data) {
    return ds3231->interface.bus_write_data(
        ds3231->interface.bus_user, write_address, write_data, write_size);
  }

  return DS3231_ERR_NULL;
}

static ds3231_err_t ds3231_bus_read_data(ds3231_t const *ds3231,
                                         uint8_t read_address,
                                         uint8_t *read_data, size_t read_size) {
  assert(ds3231);

  if (ds3231->interface.bus_read_data) {
    return ds3231->interface.bus_read_data(ds3231->interface.bus_user,
                                           read_address, read_data, read_size);
  }

  return DS3231_ERR_NULL;
}

ds3231_err_t ds3231_initialize(ds3231_t *ds3231, ds3231_config_t const *config,
  ...
  return ds3231_bus_initialize(ds3231);
}

ds3231_err_t ds3231_deinitialize(ds3231_t *ds3231) {
  assert(ds3231);

  ds3231_err_t err = ds3231_bus_deinitialize(ds3231);
...
ds3231_err_t ds3231_get_temp_data_scaled(ds3231_t const *ds3231,
                                         float *scaled) {
...
ds3231_err_t ds3231_get_control_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_CONTROL,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_set_control_reg(ds3231_t const *ds3231,
  ...
  return ds3231_bus_write_data(ds3231, DS3231_REG_ADDR_CONTROL, &data,
                               sizeof(data));
}
...
ds3231_err_t ds3231_get_status_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_STATUS, &data, sizeof(data));
...
ds3231_err_t ds3231_set_status_reg(ds3231_t const *ds3231,
  ...
  data &= ~((0x01U << 7U) | (0x01U << 3U) | (0x01U << 2U) | (0x01U << 1U) |
            (0x01U));
  ...
  err |= ds3231_bus_write_data(ds3231, DS3231_REG_ADDR_STATUS, &data,
                               sizeof(data));
...
ds3231_err_t ds3231_get_aging_offset_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_AGING_OFFSET,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_set_aging_offset_reg(ds3231_t const *ds3231,
  ...
  return ds3231_bus_write_data(ds3231, DS3231_REG_ADDR_AGING_OFFSET, &data,
                               sizeof(data));
}
...
ds3231_err_t ds3231_get_temp_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_TEMP_MSB,
                                          data, sizeof(data));
...
ds3231_err_t ds3231_get_second_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_SECOND, &data, sizeof(data));
...
ds3231_err_t ds3231_get_minute_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_MINUTE, &data, sizeof(data));
...
ds3231_err_t ds3231_get_hour_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_HOUR, &data, sizeof(data));
...
ds3231_err_t ds3231_get_day_reg(ds3231_t const *ds3231, ds3231_day_reg_t *reg) {
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_DAY, &data, sizeof(data));
...
ds3231_err_t ds3231_get_date_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_DATE, &data, sizeof(data));
...
ds3231_err_t ds3231_get_month_century_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_MONTH_CENTURY,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_year_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err =
      ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_YEAR, &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm1_second_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM1_SECOND,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm1_minute_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM1_MINUTE,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm1_hour_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM1_HOUR,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm1_day_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM1_DAY,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm1_date_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM1_DATE,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm2_minute_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM2_MINUTE,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm2_hour_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM2_HOUR,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm2_day_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM2_DAY,
                                          &data, sizeof(data));
...
ds3231_err_t ds3231_get_alarm2_date_reg(ds3231_t const *ds3231,
  ...
  ds3231_err_t err = ds3231_bus_read_data(ds3231, DS3231_REG_ADDR_ALARM2_DATE,
                                          &data, sizeof(data));
